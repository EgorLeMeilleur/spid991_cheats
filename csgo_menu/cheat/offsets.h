...
namespace globals
{
	...
	inline float glowColorTeam[] = { 0.f, 1.f, 0.f, 1.f };
	inline float glowColorEnemy[] = { 1.f, 0.f, 0.f, 1.f };

	/*inline bool chamsTeam = false;
	inline bool chamsEnemy = false;
	inline float chamsColorTeam[] = { 0.f, 1.f, 0.f, 1.f };
	inline float chamsColorEnemy[] = { 0.f, 1.f, 0.f, 1.f };*/
